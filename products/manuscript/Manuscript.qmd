...
```{r}
#| label: fig-rfsim
#| fig-cap: "Parameter tuning results of random forest model using simulated data. "
#| echo: FALSE
...
```{r}
#| label: fig-rfpredsim
#| fig-cap: "Fitting results of random forest on simulated data: predicted values vs. observed values. "
#| echo: FALSE
