...
```{r}
#| label: fig-rf
#| fig-cap: "Parameter tuning results of random forest. "
#| echo: FALSE
...
```{r}
#| label: fig-rt
#| fig-cap: "Parameter tuning results of regression tree. "
#| echo: FALSE
...
```{r}
#| label: fig-rfrt
#| fig-cap: "Comparison of random forest and regression tree: predicted values vs. observed values. "
#| echo: FALSE
